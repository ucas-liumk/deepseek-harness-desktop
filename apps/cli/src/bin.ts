...
import { consumeDesktopApiAuthorizer } from './desktop-api-auth.ts'
...
switch (invocation.mode) {
  case 'profile': {
    const desktopApiAuthorizer = consumeDesktopApiAuthorizer()
    ...
    await runProfile({
      ...
      ...(desktopApiAuthorizer === undefined ? {} : { desktopApiAuthorizer }),
