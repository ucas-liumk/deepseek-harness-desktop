...
export const zh = {
  ...
  'dialog.desktopSuccessTitle': 'Session 下载完成',
  'dialog.desktopSuccessDescription': '已保存到系统“下载”文件夹：{filename}',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'dialog.desktopSuccessTitle': 'Session download complete',
  'dialog.desktopSuccessDescription': 'Saved to the system Downloads folder: {filename}',
